...
export default function Home() {
  ...
  const { generatePlaylist, isGenerating, error, generatedPlaylist, resetGeneration } = usePlaylistGeneration();
          ...
          <div className="space-y-8">
            ...
            {generatedPlaylist && (
              <section className="space-y-6">
                ...
                <Card className="card-hover-effect overflow-hidden border-fuchsia-500/20">
                    ...
                    <div className="space-y-3">
                      {generatedPlaylist.tracks.map(({ track, reason }) => (
                        <div
                          ...
                          className="transform transition-all duration-200 hover:scale-[1.02]"
                        >
                          <TrackCard track={track} reason={reason} />
                        </div>
                      ))}
                    </div>
                  </CardContent>
